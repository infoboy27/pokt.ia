  ...
  return (
    ...
    >
      ...
      <Text py="lg" ta="center">
        {isFree &&
                  "Enjoy 150,000 free relays a month with POKT.ai on the Unstoppable Pocket Network."}
      {isUnlimited && "Unlimited relays with POKT.ai on the Unstoppable Pocket Network."}
      </Text>
