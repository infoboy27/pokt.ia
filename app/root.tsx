...
export const meta: MetaFunction = () => [
  {
    description:
      "POKT.ai Portal, your gateway to Web3 infrastructure. The POKT.ai Portal acts as your one-stop-shop to manage, and monitor your application's connection to blockchain data.",
  },
  {
    name: "robots",
